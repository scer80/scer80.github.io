...
What happens if we apply the Kramers-Moyal expansion to the Wiener process with SDE: $dx = f(x,t)\,dt + g(x,t)\,dW_t$? (see [Fokker-Planck derivation](fokker_planck.md).
