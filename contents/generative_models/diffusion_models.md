...
$$dx = \frac{\dot{\alpha}_t}{\alpha_t}\,x\,dt + \sqrt{2\sigma_t\dot{\sigma}_t - 2\frac{\dot{\alpha}_t}{\alpha_t}\sigma_t^2}\;dW_t \tag{2}$$
...
**Step 1: Direct SDE inversion.** Inverting the noising SDE (2) using the [reverse-time drift](diffusion_inversion.md) gives a reverse SDE with the **same** diffusion coefficient $g(1-u)$:
